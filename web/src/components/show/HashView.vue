    ...
    <div>
                ...
                <el-row :gutter="20">
                    <el-col :span="16">
                        <el-input  disabled :value="props.xkey">
                            <template #prepend>HASH:</template>
                        </el-input>
                    </el-col>
        ...
        <el-dialog v-model="addItemFormVisible" @close="onReset" title="新增一行">
            <el-form
                ...
                status-icon
            >
                <el-form-item label="键" prop="itemk">
                    <el-input type="textarea" v-model="addItemForm.itemk" placeholder="新增键" />
                </el-form-item>

                <el-form-item label="值" prop="itemv">
                    <el-input type="textarea" v-model="addItemForm.itemv" placeholder="新增值" />
                </el-form-item>
...
import { showHash,delHash,addHash } from "@/api/hash.js"
